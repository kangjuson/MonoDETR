...
class DepthPredictor(nn.Module):
    ...
    def __init__(self, model_cfg):
        ...
        self.pseudo_depth_mode = model_cfg.get("pseudo_depth_mode", "center")
    ...
    def forward(self, feature, mask, pos):
        ...
        depth_extent = self.extent_predictor(src) if self.extent_predictor is not None else None
        ...
        return depth_logits, depth_embed, weighted_depth, depth_pos_embed_ip, depth_extent
