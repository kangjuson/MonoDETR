...
def rotate_iou_kernel_eval(N, K, dev_boxes, dev_query_boxes, dev_iou, criterion=-1):
    ...
    tx = cuda.threadIdx.x
    row_remaining = N - row_start * threadsPerBlock
    col_remaining = K - col_start * threadsPerBlock
    row_size = row_remaining if row_remaining < threadsPerBlock else threadsPerBlock
    col_size = col_remaining if col_remaining < threadsPerBlock else threadsPerBlock
